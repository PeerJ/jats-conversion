...
fetch: jats crossref crossref-schematron nlm-stylechecker datacite doaj
...
datacite-2.2:
	...
	wget -c -P datacite/2.2  http://schema.datacite.org/meta/kernel-2.2/metadata.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-titleType-v2.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-contributorType-v2.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-dateType-v2.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-resourceType-v2.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-relationType-v2.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-relatedIdentifierType-v2.xsd
	wget -c -P datacite/2.2/include  http://schema.datacite.org/meta/kernel-2.2/include/datacite-descriptionType-v2.xsd

datacite-3.0:
	mkdir -p datacite/3.0/include
	wget -c -P datacite/3.0  http://schema.datacite.org/meta/kernel-3/metadata.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-titleType-v3.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-contributorType-v3.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-dateType-v3.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-resourceType-v3.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-relationType-v3.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-relatedIdentifierType-v3.xsd
	wget -c -P datacite/3.0/include  http://schema.datacite.org/meta/kernel-3/include/datacite-descriptionType-v3.xsd
...
doaj:
	...
	wget -c -P doaj  http://www.doaj.org/schemas/appinfo/1/appinfo.xsd
	wget -c -P doaj http://www.doaj.org/schemas/iso_639-2b/1.0/iso_639-2b.xsd
